...
$(document).ready(function () {
  ...
  function init () {
    ...
    world = document.getElementById('iskandar')
  ...
  function Iskandar () {
    ...
    this.informalSmokingMat = '#a4b357'
    this.informalLegsMMat = '#75890c'
    this.informalZipperMat = '#75890c'
    this.informalShoesMat = '#585858'
